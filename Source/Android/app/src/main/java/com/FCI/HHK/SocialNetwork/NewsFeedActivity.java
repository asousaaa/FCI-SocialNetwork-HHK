...
public class NewsFeedActivity extends FragmentActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        com.FCI.HHK.Controllers.Application.NewsFeedActivity = this;
        ...
        fragments.add(Fragment.instantiate(this, tab_page.class.getName()));
        ...
        AddTab(this.mTabHost,
                this.mTabHost.newTabSpec("Tab3")
                        .setIndicator(
                                "Pages"));
        AddTab(this.mTabHost,
                this.mTabHost.newTabSpec("Tab4").setIndicator("info"
                     ));
